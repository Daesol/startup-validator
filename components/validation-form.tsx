...
export function ValidationForm({ open, onOpenChange }: { open: boolean; onOpenChange: (open: boolean) => void }) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[600px] md:max-w-[700px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Startup Validation Form</DialogTitle>
          <DialogDescription>
            Tell us about your startup idea to get a professional validation report.
          </DialogDescription>
        </DialogHeader>
